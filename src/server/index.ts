...
async function matchParameterizedRoute(
  ...
  const patterns = [
    ...
    { pattern: "GET /api/jobs/:id/logs", parts: ["api", "jobs", ":id", "logs"] },
    { pattern: "GET /api/jobs/:id/report", parts: ["api", "jobs", ":id", "report"] },
    { pattern: "GET /api/jobs/:id/download", parts: ["api", "jobs", ":id", "download"] },
    { pattern: "POST /api/jobs/:id/stop", parts: ["api", "jobs", ":id", "stop"] },
